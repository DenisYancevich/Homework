...
export function getUserByName(userName, onSuccess, onError) {
  setTimeout(() => {
    ...
    const mockResult =
      userName === "John" ? { id: "123", name: userName } : null;
      ...
      userId === "123"
        ? [
            { id: "1", points: 5, reason: "trolling" },
            {
              id: "2",
              points: 10,
              reason: "frequent promotion of http://buy-my-product.com",
            },
            {
              id: "3",
              points: 1,
              reason:
                "posted image of dogs in cat forum: https://placedog.net/300/200",
            },
          ]
        : null;
